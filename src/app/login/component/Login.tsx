      ...
      <div className="bg-gray-100  flex  justify-center items-center  gap-5  w-full h-[700px] font-sans ">
        <div className="flex  justify-between items-center  gap-1 md:mt-20  p-6 max-w-[1000px]  max-md:flex-col  ">
          ...
          <div className=" rounded-lg max-md:flex max-md:flex-col max-md:items-center max-md:mt-5 ">
            <form className="bg-white flex flex-col p-5 pb-0 gap-4 w-[420px]  items-center shadow-2xl rounded-lg ">
              <input
              ...
              <div className="pt-3 flex w-full  items-center justify-center">
                <Link href="/nouveau-compte" className="text-[20px] font-bold  bg-green text-white  p-4 px-18 rounded-lg  hover:bg-green-600">Créer nouveau compte</Link>
              </div>
